...
The problem with working with huge CSV files is memory consumption, as we usually are not able to load all keys into RAM at once. Fortunately, pandas library offers reading and processing such files in chunks of lines. 
