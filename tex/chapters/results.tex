...
\end{sidewaysfigure}\subsection*{Training fine-tuning}
...
\begin{subfigure}{.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{tex/images/results/res_g8}  
  \caption{Group 8}
\end{subfigure}%
\begin{subfigure}{.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{tex/images/results/res_g9}
  \caption{Group 9}
\end{subfigure}
\end{figure}
...
\item binary classifiers together
